FraseDaProf = "pontoevirgulanofinaledaumenter"
quickDrawDataset = [
    "aircraft carrier",
    "airplane",
    "alarm clock",
...
document.getElementById("sketchName").innerHTML = "esboço à ser desenhado: " + sketch;
...
function setup() {
    ...
    canvas.center();
    background("white");
    canvas.mouseReleased(classifyCalvas);
}
function preload() {
...
function gotResult(error, results) {
    ...
    document.getElementById('label').innerHTML = "Sabão acha que você desenhou um " + results[0].label;
